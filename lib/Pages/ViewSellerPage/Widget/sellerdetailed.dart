...
class SellerDetailPage extends StatelessWidget {
  ...
  SellerDetailPage(this.usermodel, {Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          GetX<MainProvider>(builder: (controller) {
            return CustomSellerdetails(
              first: "${usermodel.logo}",
              second: "${usermodel.ownerName}",
              third: "Resturat Owner",
              four: "${controller.seawait.value}",
              four1: "${controller.sepen.value}",
              five: "${controller.sede.value}",
              siz: "${controller.serejected.value}",
