...
import 'customsellerdetailedview.dart';

class SellerFullDetailPage extends StatelessWidget {
  SellerModel usermodel;
  SellerFullDetailPage(this.usermodel, {Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Customdetails(
            first: "${usermodel.email}",
            second: "${usermodel.phone}",
            third: "${usermodel.storeName}",
            four: "${usermodel.location}",
            four1: "${usermodel.idCard}",
            five: "${usermodel.idCard}",
            siz: "${usermodel.idCardFront}",
            sev: "${usermodel.idCardBack}",
            ei: "${usermodel.bankAccName}",
            nine: "${usermodel.bankAccNum}",
            nine1: "${usermodel.idCardFront}",
          ),
          // Padding(
