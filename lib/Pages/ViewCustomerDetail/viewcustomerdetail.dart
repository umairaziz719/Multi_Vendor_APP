...
import 'View/viewcustDetail.dart';

class ViewCUstomerDetailPage extends StatelessWidget {
  List<OrderModel> orderModel;
  UserModel usermodel;
  ViewCUstomerDetailPage(this.usermodel, this.orderModel, {Key? key})
      : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Expanded(child: ViewCustDetail(usermodel, orderModel)),
                      ],
                    )
                  ],
                ),
