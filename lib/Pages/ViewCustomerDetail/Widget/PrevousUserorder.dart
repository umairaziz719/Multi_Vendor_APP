...
import 'customusOrdermodel.dart';

class PreviousUserOrderDetailWidget extends StatelessWidget {
  List<OrderModel> orderModel;
  PreviousUserOrderDetailWidget(this.orderModel, {Key? key}) : super(key: key);
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  CustomText(
                    text: "Previous Order History of User",
                    size: 24,
                    color: Colors.black,
                  ...
                  return Column(
                    children: [
                      ...
                      CustomUsOrderModel(
                        ...
                        second: "${orderModel[index].cartlist![0].name}",
                        third:
                            "${orderModel[index].DateTime!.toDate().toString().split(" ")[0]}",
                        four:
                            "${orderModel[index].DateTime!.toDate().toString().split(" ")[0]}",
                        five: "${orderModel[index].cartlist![0].price}",
