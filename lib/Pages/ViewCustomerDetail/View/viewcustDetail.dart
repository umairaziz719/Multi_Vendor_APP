...
import '../Widget/PrevousUserorder.dart';
import '../Widget/User/userdetail.dart';

class ViewCustDetail extends StatelessWidget {
  List<OrderModel> orderModel;
  UserModel usermodel;
  ViewCustDetail(this.usermodel, this.orderModel, {Key? key}) : super(key: key);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            PreviousUserOrderDetailWidget(orderModel),
