...
import 'useroverview.dart';

class USerDetailWidget extends StatelessWidget {
  OrderModel orderModel;
  SellerModel sellerModel;
  USerDetailWidget(this.orderModel, this.sellerModel, {Key? key})
      : super(key: key);
      ...
      child: Column(
        ...
        children: [
          GetX<MainProvider>(builder: (controller) {
            return UserOverview(
              first: "${orderModel.UserPhoto}",
              second: "${orderModel.UserName}",
              third: "Customer",
              four: "${controller.pendingus.value}",
              five: "${controller.deliverus.value}",
              siz: "${controller.cancelus.value}",
            );
          }),
          // Padding(
