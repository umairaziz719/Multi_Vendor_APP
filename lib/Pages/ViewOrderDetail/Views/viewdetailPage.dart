...
import '../Widgets/UserWidget/userdetailedwidget.dart';
import '../Widgets/UserWidget/userfulloverview.dart';
import '../Widgets/detailedOrderScreen.dart';
import '../Widgets/sellerdetailsWidget.dart';
import '../Widgets/sellerfulldetail.dart';
import '../Widgets/statusdetail.dart';

class ViewDetail extends StatelessWidget {
  OrderModel orderModel;
  SellerModel sellerModel;
  ViewDetail(this.orderModel, this.sellerModel, {Key? key}) : super(key: key);
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  flex: 1,
                  child: StatusDetails(orderModel.status),
                ),
              ],
            ),
            SizedBox(
